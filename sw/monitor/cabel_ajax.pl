...
print "<center><font color='brown'><h2>Длина кабеля:</h2> </font></center><br><div class=\"text\">";
...
for (my $i=1; $i < $nports; $i++) {
  ...
  print "<h3><b><u>Порт $i</u></b><br>Пара А: $s_A $A м<br>Пара В: $s_B $B м</h3>";
...
my $port = $i - 4 ; 
  print "<h3><b><u>Порт $port</u></b><br>Длина: $s_A $A м<br></h3>";
...
for (my $i=1; $i < $nports; $i++) {
 ...
 if ($s_B == 1 ){$s_B = 'notTested';}
  ...
  print "<h3><b><u>Порт $i</u></b><br>Пара А: $s_A $A м<br>Пара В: $s_B $B м<br></h3>";
sleep 1;
...
my @lenhgt_list =fh_cabel::NN($line);
#sleep(20);
print(@lenhgt_list);
